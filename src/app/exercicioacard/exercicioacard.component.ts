...
@Component({
  selector: 'app-exercicioacard',
  templateUrl: './exercicioacard.component.html',
  styleUrls: ['./exercicioacard.component.css']
})
export class ExercicioacardComponent implements OnInit {

  imagem = "../../../assets/exercicios/"
  imagemFim = ".gif"
  exercicios = new Datas().exer();
  cardio = new Datas().programaA()[2].dia;
